...
public class RaptureParticle extends ExplosionLargeParticle {
    public RaptureParticle(ClientWorld world, double x, double y, double z, double d, SpriteProvider spriteProvider) {
    ...
    public static class Factory implements ParticleFactory<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType particleType, ClientWorld clientWorld,
            ...
            return new RaptureParticle(clientWorld, d, e, f, g, this.spriteProvider);
        }
    }
}
